...
- [llm-sentinel](https://github.com/anushamukka9/llm-sentinel): deterministic guardrails for LLM apps: prompt-injection, secrets, PII, toxicity scanning with zero model calls ![GitHub Repo stars](https://img.shields.io/github/stars/anushamukka9/llm-sentinel?style=social)
